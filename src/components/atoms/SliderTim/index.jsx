    ...
    <>
      ...
      >
        <SwiperSlide className="">
          <div className="bg-gradient-to-br from-sky-600 to-sky-600 via-slate-400 self-start items-end origin-top hover:scale-y-110 duration-700 w-full md:h-[80%] h-[50%] overflow-hidden group">
            <div className="w-full h-full relative flex flex-wrap">
              <div className="absolute self-end group-hover:scale-110 origin-top-left duration-700">
                <img src={benkskuy} alt="" className=""/>
              </div>
