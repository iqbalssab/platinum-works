...
import { ButtonPaket, DecorSlider } from '../../components'
...
const Decoration = () => {
  ...
  return (
    <div>
        ...
        {/* summary Section */}
        <div id='summary' className='w-full h-40 relative '>
          <div className='absolute flex justify-center gap-5 px-4 py-2 -top-14 w-full h-40'>
            <div className='w-56 h-full bg-white border-t pb-2 border-dark rounded-lg shadow-md grid hover:-translate-y-5 transition duration-500 box-content'>
            ...
            <div className='w-56 h-full bg-white border-t pb-2 border-dark rounded-lg shadow-md grid box-content'>
